...
const Lnb = () => {
  ...
  return (
    <nav className='absolute bottom-0 left-0 z-[1000] flex w-[375px] max-w-xl items-center justify-between rounded-[20px] bg-white px-7 pb-3 pt-3 text-xs shadow-[0px_0px_3px_rgb(215,215,215)]'>
      <Link
        href={'/home'}
        className={cls(
